...
// absolutamente emprestado do GLFW
/* The unknown key */
...
#define MAX_KEYS_ID 348


// KEY ACTIONS
#define ENGINE_KEY_RELEASE 0
#define ENGINE_KEY_PRESS 1
#define ENGINE_KEY_HOLD 0


struct KeyInfo {
	KeyInfo() {
		last_action = ENGINE_KEY_RELEASE;
		last_mods = 0;
	}
	~KeyInfo() = default;
...
public:
	...
	void applyToCamera(Camera &camera, int windowWidth, int windowHeight);
};
